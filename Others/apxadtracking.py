...
def asoSimulator(file,times):
    ...
    '''
    #https://global.ymtracking.com/trace?offer_id=973648&aff_id=101446&aff_sub=003_20170405040219M2180&gaid=&idfa=&aff_sub2=764519&aff_sub3=402&aff_sub4=1373693191&aff_sub5=0.8
    for i in trange(0,times):
        try:
            conn = httplib.HTTPConnection("global.ymtracking.com")  # 这里是host
            conn.request('GET', '/trace?offer_id=973648&aff_id=101446&aff_sub=003_20170405040219M2180&gaid=&idfa=&aff_sub2=764519&aff_sub3=402&aff_sub4=1373693191&aff_sub5=0.8', '', {'user-agent':USER_AGENT})  # 上面是分支 注意是GET
